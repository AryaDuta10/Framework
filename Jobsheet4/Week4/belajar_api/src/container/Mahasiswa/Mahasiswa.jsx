                    ...
                    <div className="col-sm">
                        <div className="TopBar">
                            <div className="form pb-2">
                                ...
                                <div className="form-group row">
                                    <label htmlFor="date" className="col-sm-2 col-form-label">Waktu</label>
                                    <div className="col-sm-10">
                                        <input type="text" className="form-control" id="date" name="date" onChange={this.handleTambah} />
                                    </div>
                                </div>
                        ...
                        <div className="isiKonten">
                            <h2>Daftar Mahasiswa</h2><br/>{
                                this.state.listMhs.map(mahasiswa => {     // looping dan masukan untuk setiap data yang ada di listArtikel ke variabel artikel
                                    return <Post key={mahasiswa.id} nimMhs={mahasiswa.NIM} namaMhs={mahasiswa.nama} alamatMhs={mahasiswa.alamat} idMahasiswa={mahasiswa.id} noHp={mahasiswa.hp} angkatanMhs={mahasiswa.angkatan} statusMhs={mahasiswa.status} date={mahasiswa.date} hapusMahasiswa={this.handleHapus} /> // mappingkan data json dari API sesuai kategorinya
                                })
                            }
                        </div>
                    </div>
